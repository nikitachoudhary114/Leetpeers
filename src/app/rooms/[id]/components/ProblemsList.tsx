...
export function ProblemsList({ onSelectProblem, selectedProblemId }: ProblemsListProps) {
  ...
  return (
    <div className="bg-slate-800/30 rounded-2xl border border-slate-700 h-full flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-slate-700">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full bg-slate-700 border-none rounded-lg pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-400 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
          />
        </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs text-slate-500">#{problem.id}</span>
                  ...
                  <ChevronRightIcon className="w-4 h-4 text-slate-500 flex-shrink-0 mt-1" />
                </div>
              </button>
            ))}
          </div>
